  ...
  return (
    <section className=" mt-[450px]">
      ...
      <p className="grid  justify-items-center">
        <a className="font-bold lg:text-6xl sm:text-sm text-bege-escuro-2  text-center break-words ">
          looking forward to the new things the world brings{" "}
        </a>
      ...
      <p className="flex justify-center space-x-4 mt-20">
        <a
          href="https://github.com/Greedwy-Blu"
          className="font-bold text-2xl  text-bege-escuro-2  text-center"
        >
          GITHUB
        </a>
        <a
          href="https://www.linkedin.com/in/gabriel-oliveira-alves-da-silva-2838b9266/"
          className="font-bold text-2xl  text-bege-escuro-2  text-center"
        >
          LINKEDIN
        </a>
